...
namespace PluginCustomExportTutorial\Helper;

use ElasticExport\Helper\ElasticExportPropertyHelper;
use PluginCustomExportTutorial\Generator\CustomExport;
...
class AttributeHelper
{
    ...
    public function getVariationAttributes($variation, $settings):array
    {
        ...
        {
            $property = $this->elasticExportPropertyHelper->getProperty($variation, $type, CustomExport::GOOGLE_SHOPPING, $settings->get('lang'));
