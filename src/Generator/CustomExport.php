 ...
 *
 * @package PluginCustomExportTutorial\Generator
 */
class CustomExport extends CSVPluginGenerator
{
            ...
            do {
                ...
                if ( count($resultList['error']) > 0 ) {
                    $this->getLogger(__METHOD__)
                        ...
                        ->error('PluginCustomExportTutorial::log.esError', [
                ...
                if ( $shardIterator == 1 ) {
                    $this->getLogger(__METHOD__)
                        ...
                        ->debug('PluginCustomExportTutorial::logs.esResultAmount');
                }
                    ...
                    if ( is_array($resultList['documents']) && count($resultList['documents']) > 0 ) {
                        ...
                        try {
                            ...
                            if ( $this->errorIterator == 100 ) {
                                $this->getLogger(__METHOD__)->error('PluginCustomExportTutorial::logs.fillRowError', [
